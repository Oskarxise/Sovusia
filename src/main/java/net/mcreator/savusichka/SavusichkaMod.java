 ...
 *
 */
package net.mcreator.savusichka;
...
@Mod("savusichka")
public class SavusichkaMod {
	public static final Logger LOGGER = LogManager.getLogger(SavusichkaMod.class);
	public static final String MODID = "savusichka";
	...
	public SavusichkaMod() {
		...
		SavusichkaModBlockEntities.REGISTRY.register(bus);
